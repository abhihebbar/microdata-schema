...
$toolsUrl = Loader::helper('concrete/urls')->getBlockTypeToolsURL(BlockType::getByHandle('microdata_content'));
?> 
...
tinyMCE.init({
	...
	convert_urls: false,
	entity_encoding: 'raw',
	content_css : "<?php echo $theme->getThemeEditorCSS()?>,<?php echo $toolsUrl . '/md-highlight'  ?>",
	verify_html :false,
	<?php 
